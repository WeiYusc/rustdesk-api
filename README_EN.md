...
| RUSTDESK_API_GORM_CONN_MAX_IDLE_TIME                   | Maximum MySQL idle connection age. Keep it below server `wait_timeout` to avoid reusing stale connections.                                          | `1h`                          |
| RUSTDESK_API_GORM_CONN_MAX_LIFETIME                    | Maximum MySQL connection lifetime. Default stays below MySQL `wait_timeout`.                                                                        | `7h30m`                       |
